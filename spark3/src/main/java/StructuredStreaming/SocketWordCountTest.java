...
//                .option("includeTimestamp", true)
        ...
        Dataset<Row> words = lines.flatMap(new FlatMapFunction<Row, Tuple3<Integer, String, Timestamp>>() {
            @Override
            public Iterator<Tuple3<Integer, String, Timestamp>> call(Row row) throws Exception {
        ...
        }, Encoders.tuple(Encoders.INT(), Encoders.STRING(), Encoders.TIMESTAMP())).toDF("code", "app_id", "timestamp");
